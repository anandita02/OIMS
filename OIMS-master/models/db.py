...
auth.settings.extra_fields['auth_user']=[
    Field('emp_id',type='string',required=True,notnull=True),
    Field('date_of_birth',type='date',required=True),
    Field('company_id','reference company',writable=False)]
...
## Making roles dictionary globally available
ROLE_DICT = {x['role'] : x['id'] for x in db(db.auth_group).select()}
